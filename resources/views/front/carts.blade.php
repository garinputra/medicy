...
<html lang="en">
  ...
  <body>
    ...
    <section class="wrapper flex flex-col gap-2.5 pb-40">
      ...
      <form enctype="multipart/form-data" action="{{route('transaction_products.store')}}" method="POST" class="p-6 bg-white rounded-3xl" id="deliveryForm">
        @csrf
        <div class="flex flex-col gap-5">
          <!-- Address -->
    ...
    <script>
        ...
        function calculatePrice(){
            ...
            const insurance = 20/100 * subTotal;
