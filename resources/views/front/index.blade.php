...
<html lang="en">
	...
	<head>
		...
		<title>Landing Page | Herbify</title>
		<link rel="shortcut icon" href="{{asset('assets/svgs/Logo Herbify Tab.svg')}}" type="image/x-icon">
	...
	<body>
		...
		<!-- Floating navigation -->
		<nav class="fixed z-50 bottom-[30px] bg-white rounded-[50px] pt-[18px] px-10 left-1/2 -translate-x-1/2 w-80">
			<div class="flex items-center justify-center gap-5 flex-nowrap">
				<!-- Home -->
				<a href="index.html" class="flex flex-col items-center justify-center gap-1 px-1 group is-active">
				...
				<!-- Orders -->
				<a href="{{route('transaction_products.index')}}" class="flex flex-col items-center justify-center gap-1 px-1 group">
		...
		<section class="wrapper flex flex-col gap-2.5 items-center justify-center">
			<p class="text-4xl font-extrabold text-center">
				Herbal Solutions for a Healthier Life <br>
			</p>
